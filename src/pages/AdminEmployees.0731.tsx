                ...
                {filteredEmployees.map((emp, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* 사용연차 */}
                      <td className="px-4 py-2 whitespace-nowrap text-center align-middle">{leave ? leave.used_days : <span className="text-xs text-gray-400">정보 없음</span>}</td>
                      {/* 남은연차 */}
                      <td className="px-4 py-2 whitespace-nowrap text-center align-middle">{leave ? leave.remaining_days : <span className="text-xs text-gray-400">정보 없음</span>}</td>
                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-center align-middle text-gray-700">{emp.role}</td>
